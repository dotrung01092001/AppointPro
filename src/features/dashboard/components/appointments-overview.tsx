import AppointmentOverviewChart from "@/components/charts/appointments-overview-chart";
    ...
    return (
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm w-full">
            <div className='mb-6 flex items-center justify-between'>
                <h3 className='text-lg font-semibold text-[#111827]'>Appointments Overview</h3>
